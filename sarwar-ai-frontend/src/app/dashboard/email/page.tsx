...
export default function EmailPage() {
  ...
  const handleGenerate = () => {
    ...
    setLoading(true);
    setTimeout(() => {
      setOutput("Subject: Proposed Collaboration - Sarwar AI\n\nDear recipient,\n\nI am writing to you today with a beautifully drafted email generated by our premium AI engine. We believe in minimalist excellence and clear communication.\n\nBest regards,\nSarwar AI");
      setLoading(false);
    }, 1500);
  };
